...
# ---------------------------------------------------------------------------
# Fecha
# Calibrated offsets vs jsPDF source: y −4 mm, dia_cols x +4 mm.
# dia: D1 y=47.5, D2 y=53.5; col0 x=114.5, gap=7.5 mm
# mes: row1 y=67.5, row2 y=73.5; col0 x=120.5, gap=13 mm
# anio: A1 y=81.5, A2 y=87.5; col0 x=120.5, gap=7.5 mm
# ---------------------------------------------------------------------------
...
FECHA_CONFIG = {
    ...
    "dia_cols": [                                    # x/210, gap 7.5 mm  (+3.15 mm vs prev)
        117.65 / 210, 125.15 / 210, 132.65 / 210, 140.15 / 210, 147.65 / 210,
        155.15 / 210, 162.65 / 210, 170.15 / 210, 177.65 / 210, 185.15 / 210,
    ],
    "mes_row1": 66.45 / 297,                        # −1.05 mm (−6 px)
    "mes_row2": 72.45 / 297,
    ...
    "anio_rows": [79.75 / 297, 85.75 / 297],        # −1.75 mm (−10 px)
...
CURSO_CONFIG = {
    "tipo_row": 107.05 / 297,                        # +1.05 mm (+6 px)
    "tipo_cols": [                                   # gap 14 mm
        14 / 210, 28 / 210, 42 / 210, 56 / 210, 70 / 210, 84 / 210, 98 / 210,
    ],
    "digit_rows": [117.55 / 297, 123.55 / 297, 129.55 / 297],   # +1.05 mm (+6 px)
...
_LEFT_Q1_Y  = 148.9 / 297                          # +1.40 mm (+8 px)
_RIGHT_Q26_Y = 148.9 / 297
...
RESPUESTAS_CONFIG = {
    ...
    "right": {
        ...
        "cols": [119.5 / 210, 129.5 / 210, 139.5 / 210, 149.5 / 210, 159.5 / 210],
    },
}
